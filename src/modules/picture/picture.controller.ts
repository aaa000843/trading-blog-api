...
import { ConfigService } from "modules/config/config.service";
  ...
  export class PictureController {
     ...
     */
    constructor(private readonly pictureService: PictureService, private readonly configService: ConfigService) {}
    ...
    async uploadPicture( @UploadedFile(ParseFile) file: Express.Multer.File, @Body() body: PicturePropsPayload ): Promise<IPicture> {
